...
% Requisito
Mp = 20/100; % sobressinal requerido
ke = 10; % fator de melhora do erro estacionário

%==========================================================================
% Passo 1 - ganho K que garante requisito de erro estacionario
%==========================================================================
k1 = 194200 % ganho para margem de fase conforme overshoot especificado (Exemplo 11.1)
...
pm = 48.1 %100*csi % margem de fase requerida
...
wpm = 20.4; % frequencia na fase phi
...
kpm = -23.2; % magnitude (com valor negativo) na frequencia wpm 
...
pc = -0.141; % polo do compensador (valor aproximado)
